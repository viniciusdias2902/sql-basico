...
-- SQLite — Criação das tabelas e inserção de dados
-- ============================================================
...
CREATE TABLE vagas (
    ...
    remoto          INTEGER NOT NULL,  -- 0 = presencial, 1 = remoto
    data_publicacao TEXT NOT NULL,      -- formato ISO: 'YYYY-MM-DD'
...
(1,  1, 'Analista de Dados Júnior',      3200.00, 1, '2025-01-10'),
(2,  2, 'Leitor de Tarot Júnior',        1800.00, 0, '2025-01-15'),
(3,  1, 'Engenheiro de Dados',           8500.00, 1, '2025-02-01'),
(4,  3, 'DBA Júnior',                    3800.00, 0, '2025-02-10'),
(5,  4, 'Analista de QA Júnior',         2500.00, 1, '2025-02-20'),
(6,  5, 'Desenvolvedor Backend',         7200.00, 1, '2025-03-01'),
(7,  2, 'Cartomante Full Stack',         4200.00, 0, '2025-03-05'),
(8,  6, 'Analista de BI',                5500.00, 1, '2025-03-10'),
(9,  3, 'Estagiário de Dados',           1500.00, 0, '2025-03-15'),
(10, 5, 'Cientista de Dados Sênior',    12000.00, 1, '2025-03-20');
